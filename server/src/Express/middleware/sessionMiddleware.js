module.exports = {
    name: 'sessionMiddleware', service: __,
    dependencies: ['require(express-session)', 'require(connect-redis)']

};

function __(session, connectRedis) {
    ...
    const getSessionStore = function () {
        let envSessionStore = process.env.SESSION_STORE;
